...
test_data_1 = [
    ...
    ({"text3.txt": "Мария Луиса Беатрис Теран родилась в 1918 году в Росарио. "
                   ...
                   " который начал с ней заниматься[1]."}, ["text3.txt result: Язык и культура"]),
    ({"text3.txt": b"\xd0\x9c\xd0\xb0\xd1\x80\xd0\xb8\xd1\x8f "
                   ...
                   b"\xd1\x82\xd1\x8c\xd1\x81\xd1\x8f[1]."}, ["text3.txt result: Язык и культура"])
]
...
test_data_2 = [
    ...
    ({"text3.txt": "Мария Луиса Беатрис Теран родилась в 1918 году в Росарио. "
     ...
     "Существительные: 32.53 Глаголы: 1.2 "
     "Предлоги: 13.25 Союзы: 7.23 "
     "Прилагательные: 14.46 "
...
test_data_3 = [
    ...
    ({"text3.txt": "Мария Луиса Беатрис Теран родилась в 1918 году в Росарио. "
                   ...
                   "традиционном заплыве через Парану. Девочка демонстрировала упорство и способности к"
                   " игре и привлекла к себе внимание тренера сборной Аргентины в Кубке Дэвиса Сандерса,"
                   " который начал с ней заниматься[1]."}, ["text3.txt result: упорство, теранин, "
                                                            "теннис, росарио, парана, "
                                                            "отец, корт, клуб, игра, гребля, буфетчик, альбердь"]),
    ({"text3.txt": b"\xd0\x9c\xd0\xb0\xd1\x80\xd0\xb8\xd1\x8f "
                   b"\xd0\x9b\xd1\x83\xd0\xb8\xd1\x81\xd0\xb0 "
                   b"\xd0\x91\xd0\xb5\xd0\xb0\xd1\x82\xd1\x80\xd0\xb8\xd1\x81 "
                   b"\xd0\xa2\xd0\xb5\xd1\x80\xd0\xb0\xd0\xbd "
                   ...
                   b"\xd0\xbd\xd0\xb0\xd1\x87\xd0\xb0\xd0\xbb \xd1\x81 \xd0\xbd\xd0\xb5\xd0\xb9 "
                   b"\xd0\xb7\xd0\xb0\xd0\xbd\xd0\xb8\xd0\xbc\xd0\xb0"
                   b"\xd1\x82\xd1\x8c\xd1\x81\xd1\x8f[1]."}, ["text3.txt result: упорство, теранин, теннис,"
                                                              " росарио, парана, отец,"
...
test_data_4 = [
    ...
    ({"test_tomita.txt": "в рамках «Дня биологии» ИБХ РАН рассказала Анастасия Сычева аспирант ИБХ РАН."},
     ['test_tomita.txt result: tomita, doesnt work']),
