...
vect_model = load_model('hseling_api_nauchpop/'
                        'topic_module/models/model_vect.pkl')
reduce_model = load_model('hseling_api_nauchpop/'
                          'topic_module/models/model_reduce.pkl')
classify_model = load_model('hseling_api_nauchpop/'
                            'topic_module/models/model_class.pkl')
...
def get_topic(text, vectorizer=vect_model,
              reducer=reduce_model, classifier=classify_model):
